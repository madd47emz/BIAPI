...
describe('Authors API', () => {
  ...
  describe('PUT /api/authors/:id', () => {
    ...
    beforeEach(async () => {
      ...
      authorId = createResponse.body.author._id;
    });
    ...
    it('should update author with valid data', async () => {
      ...
      expect(response.body.success).toBe(true);
      expect(response.body.author.firstname).toBe(updateData.firstname);
      expect(response.body.author.lastname).toBe(updateData.lastname);
    });
  ...
  describe('DELETE /api/authors/:id', () => {
    ...
    it('should delete author with valid ID', async () => {
      ...
      const authorExists = getResponse.body.authors.some(author => author._id === authorId);
